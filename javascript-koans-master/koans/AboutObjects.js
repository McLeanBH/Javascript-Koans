describe("About Objects", function () {
  ...
  it("should know properties that are functions act like methods", function () {
    ...
    // expect(FILL_ME_IN).toMatch(battleCry); ///  this one does not make sense to me. Why does "battleCry" declared as variable invoke entire fxn?? I get the brainX4 part, but why here,
    // additionally, the tester has the answers in revere order. ??
  });
